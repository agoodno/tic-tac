...
const initialState = {
  env: 'inhouse',
  serverTemplates: serverTemplatesForEnv('inhouse'),
  queryTemplates: queryTemplatesForEnv('inhouse'),
  serverTemplate: '',
  server: '',
  countyNo: '',
  queryTemplate: '',
  ...
  switch (action.type) {
    case 'CHANGE_ENV':
      return {
        ...state,
        env: action.env,
        serverTemplates: serverTemplatesForEnv(action.env),
        queryTemplates: queryTemplatesForEnv(action.env)
      };
